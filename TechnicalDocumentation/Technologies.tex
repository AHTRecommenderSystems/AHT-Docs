...
Para el desarrollo del proyecto se propone utilizar las siguientes tecnologías que permitirán lograr los objetivos propuestos en el sistema. Las ventajas que representan para el desarrollo son descritas a continuación.
	...
	\begin{center}
	  \begin{tabular}{ | c | p{10cm} | }
	    ...
	    \end{itemize} \\
	    \midrule
	    \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth, height=30mm]{images/neo4j}} &
	    \begin{itemize}[topsep=0pt]
	      \item  
	    \end{itemize} \\
	    \midrule    
	    \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth, height=15mm]{images/maven}} &
	    \begin{itemize}[topsep=0pt]
	      \item 
	    \end{itemize} \\
	    \midrule
	    \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth,height=1.6cm]{images/jquery}} &
	    \begin{itemize}[topsep=0pt]
	      \item  
	    \end{itemize} \\
	    \midrule
	    \raisebox{-\totalheight}{\includegraphics[width=0.3\textwidth,height=1.6cm]{images/git}} &
	    \begin{itemize}[topsep=0pt]
	      \item  
	    \end{itemize} \\
	    \bottomrule
